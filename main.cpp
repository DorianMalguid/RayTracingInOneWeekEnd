...
// Lance un rayon dans le monde, il peut rebondir jusqu�� depth fois
...
// G�n�re une sc�ne al�atoire avec des boules compos�es des trois mat�riaux diff�rents
...
// Lance les rayons dans le monde et agr�ge les r�sultats dans le tableau colour_buf
...
void write_image_file(float* colour_buf, int nb_col) {
    ...
    while (i < nb_col) {
        ...
        // Parfois des pixels sont corrompus (~1/100 000) donc dans ce cas on reprend la valeur pr�c�dente
        // pour pouvoir ouvrir l�image quand m�me
    ...
    cout << px_corrompus << " pixels corrompus r��crits" << endl;
}
...
int main()
{
    ...
    // G�n�ration de la sc�ne
    cout << "G�n�ration de la sc�ne" << endl;
    ...
    // On initialise un tableau de flottants dans lequel les threads pourront actualiser les couleurs calcul�es
    ...
    // �criture du fichier ppm
    cout << "�criture de l�image" << endl;
    startTime = duration_cast<milliseconds>(system_clock::now().time_since_epoch());
